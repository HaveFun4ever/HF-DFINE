...
if __name__ == '__main__':
    ...
    # priority 0
    parser.add_argument('-c', '--config', default=r"/root/autodl-tmp/deim_mo/DEIM/configs/yaml/dfine_hgnetv2_s_mg.yml",type=str)
    ...
    parser.add_argument('--use-amp', action='store_true',default=False,help='auto mixed precision training')
